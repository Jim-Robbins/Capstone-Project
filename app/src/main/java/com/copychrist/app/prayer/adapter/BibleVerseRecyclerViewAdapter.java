...
public class BibleVerseRecyclerViewAdapter extends RecyclerView.Adapter<BibleVerseRecyclerViewAdapter.ViewHolder> {
    ...
    private List<String> previousPassages;
    ...
    public BibleVerseRecyclerViewAdapter(Context context, List<String> previousPassages,
                                         BiblePassageAdapterListener listener) {
        super();
        this.context = context;
        this.biblePassageAdapterListener = listener;
        this.previousPassages = new ArrayList(previousPassages);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(previousPassages.contains(biblePassage.getPassageReference())) {
    ...
    public void setAdapterListener(final BiblePassageAdapterListener biblePassageAdapterListener) {
        this.biblePassageAdapterListener = biblePassageAdapterListener;
    }
