...
public class AddPrayerRequestPresenterImpl
        implements AddPrayerRequestPresenter, DatabaseSerivce.OnTransactionCallback {
    ...
    public AddPrayerRequestPresenterImpl(final DatabaseSerivce realmService, int contactId) {
